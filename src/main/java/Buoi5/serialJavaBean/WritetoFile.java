...
public class WritetoFile { 
    public static void main(String[] args) throws IOException {       
        String outputFile = "testObjectFile.txt";
        ...
        try {
           ...
           Student st2 = new Student ("Hoten", dateFormat.parse("10-10-1999")  , false, 27, 80.5f);
           
           objectOutput.writeObject(st1);
           objectOutput.writeObject(st2);
